...
class Hands:
        ...
        # Two pair || Three of a kind
            ...
            for i in range(len(dictvalue)):
                ...
                # Three of a kind
                    ...
                    return "Three_of_a_kind", newlist
        ...
        # Full house || Four of a kind
            ...
            for i in range(len(dictvalue)):
                ...
                # Four of a kind
                    ...
                    return "Four_of_a_kind", newlist
        # High card
        elif len(cards_by_ranks) == 5:
            return "High_card", sorted(dictkey, reverse= True)
    ...
    def tell_hand_ranking(self, cards):
        ...
        if straight_val and (find_val[0] == "High_card") and not flush_val:
            return straight_val
        elif straight_val and flush_val:
            return "Straight_flush", self.is_straight(cards)[1]
        elif (find_val[0] == "High_card") and flush_val:
            return flush_val
        elif find_val[0] == "High_card":
            return find_val
    ...
    def tie_break(self, other):
        rank_list = {"High_card" : 0, "One_pair" : 1, "Two_pairs" : 2, "Three_of_a_kind" : 3, "Straight" : 4,
...
if __name__ == '__main__':
    ...
    # print(Ranking.Flush)
    # print(Ranking.Flush > Ranking.One_pair)
    # print(Ranking(0))
